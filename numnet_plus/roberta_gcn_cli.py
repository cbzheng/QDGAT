...
def main():
    ...
    if not args.tag_mspan:
        train_itr = DropBatchGen(args, data_mode="train", tokenizer=tokenizer, cross_index=2)
        dev_itr = DropBatchGen(args, data_mode="dev", tokenizer=tokenizer, cross_index=2)
    else:
