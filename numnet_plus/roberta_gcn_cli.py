...
<<<<<<< HEAD
    ...
    if not args.tag_mspan:
        train_itr = DropBatchGen(args, data_mode="train", tokenizer=tokenizer, cross_index=0)
        dev_itr = DropBatchGen(args, data_mode="dev", tokenizer=tokenizer, cross_index=0)
    else:
...
=======
    for i in range(cross_validation_length):
        ...
        cross_avg_f1[i] = best_f1
        cross_avg_em[i] = best_em
>>>>>>> c07e41ca4963652cbc26fd0550532bcdda699cf3
